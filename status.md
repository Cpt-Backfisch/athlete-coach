...
PR 1 (Foundation) und PR 2 (Charts + Events) gemergt. App hat jetzt echtes Schwarz im Dark Mode mit manuellem Toggle, korrekte Mobile-Safe-Area, fünf neue Dashboard-Charts, Triathlon-Detail-Views mit Splits und vollständige Renn-Historie in Supabase. Telegram-Push nach Aktivität: Fix deployed (22.04.), Bestätigung steht aus. Nächster Schritt: PR-Block Polish (Kommentare-Layout Desktop, Empty States, Skeleton-Loader, Toasts, Pull-to-Refresh, Activity-Card-States) und weitere UI-Verbesserungen.
