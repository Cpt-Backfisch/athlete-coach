...
React-Migration ist abgeschlossen, App läuft unter /app/ parallel zur alten Monolith. Schema-Fix (PRs #32, #33) und alle bekannten Post-Migration-Bugs (PRs #37, #38, Proxy PR #3) sind gefixt. Telegram-Push nach Aktivität: Fix deployed (22.04.), Bestätigung steht aus. Nächste offene Themen: fehlende Dashboard-Charts, Dark-Mode-Fix iOS, Import-Strategie, Phase-2-Features.
...
- [ ] **Fehlende Dashboard-Charts** (identifiziert 22.04.2026):
  - Wochenkarte (Kalenderansicht Trainingswochen)
  - Trainingsumfang Stunden/km
  - Sportverteilung (Tortendiagramm o.ä.)
  - Kumulierte Trainingszeit Jahresvergleich
- [ ] **Dark Mode Fix iOS** — Texte auf iPhone im Dark Mode schwarz auf dunklem Hintergrund, nicht lesbar. Siehe Abschnitt 3 Bekannte Bugs.
...
**2. Dark Mode iOS — Text nicht lesbar**

Auf iPhone im Dark Mode erscheinen Texte schwarz auf dunklem Hintergrund (nicht lesbar).
Datum: 22.04.2026. Vermutete Ursache: fehlende `color-scheme`-Deklaration oder shadcn/ui-Theme-Variablen werden von Safari iOS im Dark Mode nicht korrekt aufgelöst.
Priorität: hoch (betrifft Mobile-Nutzung direkt).
